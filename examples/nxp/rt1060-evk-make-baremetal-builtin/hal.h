...
static inline void flash_init(void) { // QSPI in FlexSPI
  ...
  periph_mux_config(kIOMUXC_FLEXSPIA_DQS_SELECT_INPUT, 1);  // drive peripheral from B1_05
  ...
  periph_mux_config(kIOMUXC_FLEXSPIA_SCK_SELECT_INPUT, 1);  // drive peripheral from B1_07
  ...
  periph_mux_config(kIOMUXC_FLEXSPIA_DATA0_SELECT_INPUT, 1);  // drive peripheral from B1_08
  ...
  periph_mux_config(kIOMUXC_FLEXSPIA_DATA1_SELECT_INPUT, 1);  // drive peripheral from B1_09
  ...
  periph_mux_config(kIOMUXC_FLEXSPIA_DATA2_SELECT_INPUT, 1);  // drive peripheral from B1_10
  ...
  periph_mux_config(kIOMUXC_FLEXSPIA_DATA3_SELECT_INPUT, 1);  // drive peripheral from B1_11
